...
export default function ProfileSection() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center  md:items-start gap-6 md:gap-12 p-6 md:p-12 bg-[#fdf8f0]">
      {/* Left: Video Section */}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                ...
                className={`w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center cursor-pointer
                  ...
                  ${isPlaying ? "bg-red-950" : "bg-red-950"}
                `}
              >
                <svg
      ...
      <div className="w-full md:w-1/2 h-[450px] flex  justify-start items-start flex-col">
        ...
        <p className="text-gray-700 leading-relaxed lg:text-xl">
          ...
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa pariatur, ad mollitia voluptates esse repellendus cum aperiam odit porro impedit. Architecto, dolorem ea? Iure nulla molestias corrupti porro aut deleniti!
        </p>
      </div>
    </div>
  );
