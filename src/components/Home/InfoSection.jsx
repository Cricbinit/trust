...
const InfoSection = () => {
  return (
    <div className="bg-[#f9f7f3] rounded-2xl p-4 sm:p-6 md:p-12 max-w-7xl mx-auto mt-6 sm:mt-10">
      {/* Top Row */}
      <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center text-center md:text-left">
        ...
        <div>
          ...
          <a
            href="#"
            className="text-blue-900 underline font-medium mt-3 sm:mt-4 inline-block"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-8 md:mt-10">
        ...
        <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-start gap-4">
          ...
          <div>
            ...
            <a
              href="#"
              className="text-blue-900 underline font-medium mt-2 inline-block"
            >
